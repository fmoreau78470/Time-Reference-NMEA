...
Bienvenue dans la documentation de **Time Reference NMEA**.

Ce projet vous permet de transformer un simple PC Windows en un **serveur de temps de haute précision (Stratum 1)**, capable de fonctionner sans aucune connexion Internet, grâce à un simple module GPS USB.

## Pourquoi ce projet ?

À l'origine conçu pour l'astronomie amateur (occultations stellaires, courbes de lumière), ce système garantit une horloge système précise à la milliseconde près, là où la synchronisation Internet (NTP classique) peut varier de plusieurs dizaines de millisecondes.

## Fonctionnalités clés

*   **Indépendance totale :** Fonctionne hors ligne (déserts, montagne, mer).
*   **Précision :** Utilise le signal PPS (Pulse Per Second) du GPS.
*   **Visualisation :** Interface graphique moderne pour surveiller la qualité du signal et la dérive.
